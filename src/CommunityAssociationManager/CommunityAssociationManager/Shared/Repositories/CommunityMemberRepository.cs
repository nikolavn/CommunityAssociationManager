...
namespace CommunityAssociationManager.Shared.Repositories
{
    internal class CommunityMemberRepository : ICommunityMemberRepository
    {
        ...
        public IList<Community> GetCashieredCommunities()
        {
            throw new NotImplementedException();
        }

        public CommunityMember GetCommunityMember(uint communityMemberId)
        {
            throw new NotImplementedException();
        }

        public IList<Property> GetCommunityMemberProperties()
        {
            throw new NotImplementedException();
        }

        public IList<Community> GetManagedCommunities()
        {
            throw new NotImplementedException();
        }
